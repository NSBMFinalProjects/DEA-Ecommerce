...
public class ProductDAO {
    ...
    public List<Product> getProductsByCollectionName(String collectionName) throws SQLException {
        List<Product> products = new ArrayList<>();
        String query = "SELECT p.* FROM dea.products p " +
                "JOIN dea.product_collections pc ON p.id = pc.product_id " +
                "JOIN dea.collections c ON pc.collection_id = c.id " +
                "WHERE c.name = ?";
