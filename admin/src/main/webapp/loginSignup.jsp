  ...
  <div class="containerLogin go-register">
    ...
    <div class="form__container form__container-login">
      <form class="form formLogin">
        <div class="left-column">
          ...
          <p style="margin-top: 1px">Login with your admin credentials</p>
    ...
    <div class="overlay-container">
      ...
      <div class="overlay overlay--right">
        ...
        <p class="overlay__desc">Sign up as a admin</p>
        <p class="overlay__desc"></p>
      ...
      <div class="overlay overlay--left">
        <h3 class="overlay__heading" style="color: #ffffff">Have an</h3>
        <h3
