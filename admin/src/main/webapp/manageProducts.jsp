        ...
        >
            ...
            <div class="tab-content" id="tab-content">
                ...
                "
                    >
                        <div style="width: 49%">
                            <p style="color: #ffffff; font-weight: 600">Product size :</p>
                            <div class="input-group" style="margin-top: -10px">
                                <select
                                        class="form-select"
                        ...
                        <div style="overflow-x: auto; padding-bottom: 40px">
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div>
                                            <img onclick="deleteItemMen();" style="cursor: pointer; margin: 8px;" src="assets/delete2.svg" alt="" />
                                            <img onclick="editItemMen();" style="cursor: pointer; margin: 8px;" src="assets/edit.svg" alt="">
                                        </div>
                                    </td>
                                </tr>
                        ...
                        <div style="overflow-x: auto; padding-bottom: 40px">
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div>
                                            <img onclick="editItemWomen();" style="cursor: pointer; margin: 8px;" src="assets/delete2.svg" alt="" />
                                            <img onclick="editItemWomen();" style="cursor: pointer; margin: 8px;" src="assets/edit.svg" alt="">
                                        </div>
                                    </td>
                                </tr>
